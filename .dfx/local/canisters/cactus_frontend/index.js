...
import { idlFactory } from './cactus_frontend.did.js';
export { idlFactory } from './cactus_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CACTUS_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cactus_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cactus_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cactus_frontend.did.js")._SERVICE>}
 */
export const cactus_frontend = createActor(canisterId);
