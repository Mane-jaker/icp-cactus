...
import { idlFactory } from './cat_backend.did.js';
export { idlFactory } from './cat_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CAT_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cat_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cat_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cat_backend.did.js")._SERVICE>}
 */
export const cat_backend = createActor(canisterId);
